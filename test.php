...
$query = "
SELECT SUM(p.dep_amount) AS mem_deposit, DATE_FORMAT(p.dep_date, '%M') AS mem_date
FROM member m
JOIN deposit p ON p.mem_id = m.mem_id
GROUP BY DATE_FORMAT(p.dep_date, '%M%')
";
...
<ul class="breadcrumb">
    ...
    <li class="active">รายงานข้อมูลการฝากเงินสมาชิก</li>
</ul>

<!-- END BREADCRUMB -->

<div class="page-title">                    
    <h2><i class="fa fa-info-circle"></i> รายงานข้อมูลการฝากเงินสมาชิก</h2>
</div>
