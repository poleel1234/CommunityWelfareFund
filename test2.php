...
$query = "SELECT DATE_FORMAT(g.pay_date,'%M') as mem_date,e.pet_type,SUM(g.pet_amount) as mem_deposit
FROM payment g
...
<ul class="breadcrumb">
    ...
    <li class="active">รายงานข้อมูลผู้สูงอายุยอดเงินสถาบัน</li>
</ul>

<!-- END BREADCRUMB -->

<div class="page-title">                    
    <h2><i class="fa fa-info-circle"></i> รายงานข้อมูลผู้สูงอายุยอดเงินส่งสถาบัน</h2>
</div>
